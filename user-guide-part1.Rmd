...
```{bash basic.3.multi2}
source session-setup.sh
cat data/user-guide.expl1/cases.txt | cut -f 1 | verif-author.pl -H configs/basic.3.conf
```
...
```{bash stopwords3}
source session-setup.sh
verif-author.pl -H -v mt-100:$OUTPUT_DIR/mt-100.stop-list configs/basic.4.conf data/gb/1876-mt-taots:data/gb/1884-mt-taohf data/gb/1888-hj-tap:data/gb/1896-hj-tsop:data/gb/1898-hj-ttm
```
...
```{bash univ.1}
source session-setup.sh
time verif-author.pl -H configs/univ.1.conf data/gb/1876-mt-taots:data/gb/1884-mt-taohf data/gb/1888-hj-tap:data/gb/1896-hj-tsop:data/gb/1898-hj-ttm
```
...
```{bash gi.1}
source session-setup.sh
verif-author.pl -H -d $OUTPUT_DIR configs/GI.1.conf data/gb/1876-mt-taots:data/gb/1884-mt-taohf data/gb/1888-hj-tap:data/gb/1896-hj-tsop:data/gb/1898-hj-ttm
```
...
ls data/gb/1876-mt-taots data/gb/1884-mt-taohf data/gb/1888-hj-tap data/gb/1896-hj-tsop data/gb/1898-hj-ttm >$OUTPUT_DIR/probe-files.list
...
```{bash gi.2}
source session-setup.sh
time verif-author.pl -H -d $OUTPUT_DIR configs/GI.1.conf data/gb/1876-mt-taots:data/gb/1884-mt-taohf data/gb/1888-hj-tap:data/gb/1896-hj-tsop:data/gb/1898-hj-ttm
```
...
cp data/user-guide.expl1/resources-options.conf "$OUTPUT_DIR"/sup1
...
n=$(cat user-guide.output/sup1/cases.txt  | wc -l)
