...
* Note: `nb.cores` should be set to represent the number of cores available on the machine.
...
- An external script `task-distrib-daemon.sh` runs in the background, picks up the tasks written in `~/tasks` and runs them in parallel.
