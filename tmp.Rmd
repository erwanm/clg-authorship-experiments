...
- The output is found in `$OUTPUT_DIR/gen1/`:
    - The `best-configs` contains the top N configuration files (in the above configuration N=100)
    - The file `best-configs.res` contains the CV performance of the top N configs
    - The file `all-configs.results` contains the CV performance of all the configs evaluated for every generation (caution: the configs ids are different from the ids of the top configs).
